...
class SeleniumManager:
    ...
    periodicos = {
        ...
        "universal": "https://www.eluniversal.com.mx/buscar/policia%20muerto"
    }

    def __init__(self):
        #self.driver=webdriver.Firefox(executable_path=r"C:/Users/Luis Da/Documents/9o Semestre/semana i/geckodriver.exe")
        self.driver = webdriver.PhantomJS(executable_path=r"/home/ubuntu/environment/semanai/phantomjs-2.1.1-linux-x86_64/bin/phantomjs")
...
def main():
    sm = SeleniumManager()
    liga = sm.ligaBusquedaUniversal("policias muertos")
    sm.abrir(liga)
    links = sm.getLinks()
    #sm.escribirArchivo("C:/Users/Luis Da/Documents/9o Semestre/semana i/htmlResult.html", str(links))
    sm.exit()
